# -*- coding: utf-8 -*-
"""
Created on Wed May 24 18:39:16 2023
...
for i in range(2,10):
    ...
    inotaajustada, inotanorm, idistancia, itrazas_bien, itrazas_mal,          \
        ...
        inum_clusters = Algorithm.EM_GMM(lista_trazas = lista_trazas,         \
                                  lista_vertices = lista_vertices,            \
                                  fit_trazas = None, sample_weight = None,    \
                                  num_clusters = 215, graficas = False)
...
print('Ajuste realizado con: EM-GMM sin eliminar 0')
