...
def tabla_trazas(lista_vertices: np.array(np.array(3)),                       \
    ...
    identificados.
    Se necesita que el número de trazas sea constante en todos los vértices
    (Se puede solucionar pasando num_trazas como un diccionario si fuese
     necesario. Aún así se necesita conocer previamente cuantas trazas por
     vértice)
    Parameters
    ----------
    lista_vertices : np.array(np.array(3))
